...
print_help() {
    echo "This is a tool that enumerates S3 buckets and returns the ones which are public. The public ones will be stored to target.txt"
